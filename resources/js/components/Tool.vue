    ...
    <loading-view :loading="loading">
        ...
        <ul class="list-reset flex border-b2 ml-8">
            <li class="mr-1" v-for="(group,key,i) in groups" :key="'tab'+key">
                <a class="bg-white inline-block border-50 border-l border-t border-r rounded-t py-2 px-6 cursor-pointer" @click.prevent="selectTab(i)" :class="i===selectedTab?'font-semibold text-primary':'border-b'">{{key}}</a>
            </li>
        </ul>
