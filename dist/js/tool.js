...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        createResourceFormData: function createResourceFormData() {
            ...
            return __WEBPACK_IMPORTED_MODULE_2_lodash___default.a.tap(new FormData(), function (formData) {
                __WEBPACK_IMPORTED_MODULE_2_lodash___default.a.each(_this.fields, function (field) {
                    field.fill(formData);
                });
            });
        }
    ...
    computed: {
        ...
        groups: function groups() {
            return __WEBPACK_IMPORTED_MODULE_2_lodash___default.a.groupBy(this.fields, 'section');
        }
    }
});
